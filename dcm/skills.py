...
url_base = 'https://www.robotevents.com/api/v2/teams/130544/skills?season%5B%5D=173'
...
print("BEST:   Programming: " + str(bestp) + "    Driver " + str(bestd))
bestp = 0
bestd = 0 
